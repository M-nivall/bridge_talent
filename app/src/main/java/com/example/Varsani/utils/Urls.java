...
public class Urls {
    ...
    public static String ipAddress = "http://192.168.137.140/bridge_talent/";
    //public static String ipAddress = "https://e5cb-197-248-201-21.ngrok-free.app/bridge_talent/";
    ...
    public static  final String UEL_FEEDBACK_SEND=ROOT_URL+"applicants/send_feedback.php";

    public static  final String UEL_STAFF_SEND_FEEDBACK=ROOT_URL+"applicants/staff_sendfeedback.php";
    public static  final String UEL_STAFF_FEEDBACK=ROOT_URL+"applicants/getstafffeedback.php";
    ...
    public static final String URL_POST_JOB = ROOT_URL +"employer/post_job.php";

    public static final String URL_DOCUMENTS = ROOT_URL + "applicants/uploads/";
    // user
...
//    SUPPLIERS
   ...
   // orders
    ...
    public static final String URL_APPROVE_PAYMENT=ROOT_URL + "finance/approve_payment.php";
    public static final String URL_APPROVED_PAYMENTS=ROOT_URL + "finance/approved_payments.php";
