                        ...
                        try {
                            ...
                            if (status.equals("1")) {
                                ...
                                for (int i = 0; i < jsonArray.length(); i++) {
                                    ...
                                    String skills = jsn.getString("skills");
                                    String education = jsn.getString("education");
                                    String profileUrl = jsn.getString("profileUrl");

                                    session.loginUser(clientID, firstname, lastname, username, phoneNo, email, dateCreated, user_type, bio, skills, education, profileUrl);
