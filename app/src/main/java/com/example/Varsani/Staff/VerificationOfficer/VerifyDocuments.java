...
import static com.example.Varsani.utils.Urls.URL_VERIFICATIONS;
...
import com.example.Varsani.Staff.VerificationOfficer.Adapters.AdapterVerifications;
...
public class VerifyDocuments extends AppCompatActivity {
    private List<MyJobsModel> list;
    private AdapterVerifications adapterVerifications;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        getSupportActionBar().setSubtitle("Verify Applications Documents");
    ...
    public void getApplicants(){
        StringRequest stringRequest=new StringRequest(Request.Method.POST, URL_VERIFICATIONS,
                    ...
                    public void onResponse(String response) {
                        ...
                        try {
                            ...
                            if(status.equals("1")){
                                ...
                                adapterVerifications=new AdapterVerifications(getApplicationContext(),list);
                                recyclerView.setAdapter(adapterVerifications);
