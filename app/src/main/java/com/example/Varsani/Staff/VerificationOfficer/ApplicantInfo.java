...
import static com.example.Varsani.utils.Urls.URL_APPLICANT_TO_VERIFY;
...
import com.example.Varsani.Staff.VerificationOfficer.Adapters.AdapterDocuments;
...
public class ApplicantInfo extends AppCompatActivity {
    ...
    public void getApplicant(){
        StringRequest stringRequest=new StringRequest(Request.Method.POST, URL_APPLICANT_TO_VERIFY,
                    ...
                    public void onResponse(String response) {
                        ...
                        try {
                            ...
                            if(status.equals("1")){
                                ...
                                adapterDocuments=new AdapterDocuments(getApplicationContext(),list);
