...
import com.example.Varsani.Staff.VerificationOfficer.ApplicationDocumets;
import com.example.Varsani.utils.SessionHandler;

import java.util.List;

public class AdapterDocuments extends RecyclerView.Adapter<RecyclerView.ViewHolder>{
...
//    private OnMoreButtonClickListener onMoreButtonClickListener;
    ...
    public AdapterDocuments(Context context, List<ApplicantsModel> items) {
        this.items = items;
        ctx = context;
    }
    ...
    public RecyclerView.ViewHolder onCreateViewHolder(ViewGroup parent, int viewType) {
        ...
        vh = new AdapterDocuments.OriginalViewHolder(v);
        return vh;
    }
    ...
    public void onBindViewHolder(RecyclerView.ViewHolder holder, final int position) {
        if (holder instanceof AdapterDocuments.OriginalViewHolder) {
            final AdapterDocuments.OriginalViewHolder view = (AdapterDocuments.OriginalViewHolder) holder;
            ...
            view.btn_job_details.setOnClickListener(new View.OnClickListener() {
                ...
                public void onClick(View v) {
                    ...
                    Intent in = new Intent(ctx, ApplicationDocumets.class);
