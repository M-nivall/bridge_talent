...
import com.example.Varsani.Staff.VerificationOfficer.JobInformation;
import com.example.Varsani.utils.SessionHandler;

import java.util.List;

public class AdapterVerifications extends RecyclerView.Adapter<RecyclerView.ViewHolder>{
    ...
    public AdapterVerifications(Context context, List<MyJobsModel> items) {
        this.items = items;
        ctx = context;
    }
    ...
    public RecyclerView.ViewHolder onCreateViewHolder(ViewGroup parent, int viewType) {
        ...
        vh = new AdapterVerifications.OriginalViewHolder(v);
        return vh;
    }
    ...
    public void onBindViewHolder(RecyclerView.ViewHolder holder, final int position) {
        if (holder instanceof AdapterVerifications.OriginalViewHolder) {
            final AdapterVerifications.OriginalViewHolder view = (AdapterVerifications.OriginalViewHolder) holder;
            ...
            view.btn_job_details.setOnClickListener(new View.OnClickListener() {
                ...
                public void onClick(View v) {
                    ...
                    Intent in = new Intent(ctx, JobInformation.class);
