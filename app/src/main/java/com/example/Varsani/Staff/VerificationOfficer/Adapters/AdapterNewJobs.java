...
public class AdapterNewJobs extends RecyclerView.Adapter<RecyclerView.ViewHolder>{
    private List<NewJobsModel> items;
    private Context ctx;
...
//    private OnMoreButtonClickListener onMoreButtonClickListener;
    ...
    public AdapterNewJobs(Context context, List<NewJobsModel> items) {
        this.items = items;
        ctx = context;
    }
    ...
    public RecyclerView.ViewHolder onCreateViewHolder(ViewGroup parent, int viewType) {
        ...
        vh = new AdapterNewJobs.OriginalViewHolder(v);
        return vh;
    }
    ...
    public void onBindViewHolder(RecyclerView.ViewHolder holder, final int position) {
        if (holder instanceof AdapterNewJobs.OriginalViewHolder) {
            final AdapterNewJobs.OriginalViewHolder view = (AdapterNewJobs.OriginalViewHolder) holder;

            final NewJobsModel o= items.get(position);
