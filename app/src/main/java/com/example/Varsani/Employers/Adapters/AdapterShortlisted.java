...
import com.example.Varsani.Employers.ShortlistedDetails;
import com.example.Varsani.R;
import com.example.Varsani.utils.SessionHandler;

import java.util.List;

public class AdapterShortlisted extends RecyclerView.Adapter<RecyclerView.ViewHolder>{
...
//    private OnMoreButtonClickListener onMoreButtonClickListener;
    ...
    public void onBindViewHolder(RecyclerView.ViewHolder holder, final int position) {
        if (holder instanceof AdapterShortlisted.OriginalViewHolder) {
            final AdapterShortlisted.OriginalViewHolder view = (AdapterShortlisted.OriginalViewHolder) holder;
            ...
            view.btn_job_details.setOnClickListener(new View.OnClickListener() {
                ...
                public void onClick(View v) {
                    ...
                    Intent in = new Intent(ctx, ShortlistedDetails.class);
