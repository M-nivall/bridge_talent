...
import static com.example.Varsani.utils.Urls.URL_SHORTLISTED;
...
public class ShortlistedApplicants extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_shortlisted_applicants);

        getSupportActionBar().setSubtitle("Shortlisted Applicants");
    ...
    public void getApplicants(){
        StringRequest stringRequest=new StringRequest(Request.Method.POST, URL_SHORTLISTED,
